/**
  ...
  ******************************************************************************
  */
#ifndef AI_VEHICLE_DETECTOR_H
#define AI_VEHICLE_DETECTOR_H

#include "vehicle_detector_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_VEHICLE_DETECTOR_MODEL_NAME          "vehicle_detector"
#define AI_VEHICLE_DETECTOR_ORIGIN_MODEL_NAME   "uint8float_mobilenetv20_35_acc0_972"

/******************************************************************************/
#define AI_VEHICLE_DETECTOR_ACTIVATIONS_ALIGNMENT   (4)
#define AI_VEHICLE_DETECTOR_INPUTS_IN_ACTIVATIONS   (4)
#define AI_VEHICLE_DETECTOR_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_VEHICLE_DETECTOR_IN_NUM        (1)

AI_DEPRECATED
#define AI_VEHICLE_DETECTOR_IN \
  ai_vehicle_detector_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_VEHICLE_DETECTOR_IN_SIZE { \
  AI_VEHICLE_DETECTOR_IN_1_SIZE, \
}
#define AI_VEHICLE_DETECTOR_IN_SIZE_BYTES { \
  AI_VEHICLE_DETECTOR_IN_1_SIZE_BYTES, \
}
#define AI_VEHICLE_DETECTOR_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_VEHICLE_DETECTOR_IN_1_HEIGHT      (96)
#define AI_VEHICLE_DETECTOR_IN_1_WIDTH       (96)
#define AI_VEHICLE_DETECTOR_IN_1_CHANNEL     (3)
#define AI_VEHICLE_DETECTOR_IN_1_SIZE        (27648)
#define AI_VEHICLE_DETECTOR_IN_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_VEHICLE_DETECTOR_OUT_NUM       (1)

AI_DEPRECATED
#define AI_VEHICLE_DETECTOR_OUT \
  ai_vehicle_detector_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_VEHICLE_DETECTOR_OUT_SIZE { \
  AI_VEHICLE_DETECTOR_OUT_1_SIZE, \
}
#define AI_VEHICLE_DETECTOR_OUT_SIZE_BYTES { \
  AI_VEHICLE_DETECTOR_OUT_1_SIZE_BYTES, \
}
#define AI_VEHICLE_DETECTOR_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_VEHICLE_DETECTOR_OUT_1_CHANNEL     (15)
#define AI_VEHICLE_DETECTOR_OUT_1_SIZE        (15)
#define AI_VEHICLE_DETECTOR_OUT_1_SIZE_BYTES  (60)

/******************************************************************************/
#define AI_VEHICLE_DETECTOR_N_NODES (84)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup vehicle_detector
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_vehicle_detector_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_vehicle_detector_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_error ai_vehicle_detector_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_error ai_vehicle_detector_create(
 ...
 */
AI_API_ENTRY
ai_handle ai_vehicle_detector_destroy(ai_handle network);
 ...
 * @ref ai_vehicle_detector_create. Both the activations memory buffer 
 ...
 * using @ref ai_vehicle_detector_get_error
 */
AI_API_ENTRY
ai_bool ai_vehicle_detector_init(
 ...
 */
AI_API_ENTRY
ai_error ai_vehicle_detector_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_vehicle_detector_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_vehicle_detector_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_VEHICLE_DETECTOR_*
 * defines into file @ref vehicle_detector.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_vehicle_detector_run(
 ...
 */
AI_API_ENTRY
ai_i32 ai_vehicle_detector_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_VEHICLE_DETECTOR_H */
